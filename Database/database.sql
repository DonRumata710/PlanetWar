CREATE DATABASE  IF NOT EXISTS `planetwars` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `planetwars`;
...
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
...
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `block_user`(IN admin_id VARCHAR(30), IN user_id INT, IN reason VARCHAR(45))
BEGIN
	CALL change_user_state(FALSE, admin_id, user_id, reason);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `change_user_state` */;
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `leave_all_sessions` */;
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `leave_all_sessions`(IN playerId INT)
BEGIN
	DELETE FROM `planetwars`.`session_members` WHERE `user_id`=playerId AND `session_id` IN (SELECT `id` FROM `planetwars`.`session_list` WHERE `start_time` IS NULL);
    DELETE FROM `planetwars`.`session_list` WHERE `start_time` is NULL AND `id` NOT IN (SELECT `session_id` FROM `planetwars`.`session_members`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `remove_player_from_session` */;
ALTER DATABASE `planetwars` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `remove_player_from_session`(IN sessionId INT, IN playerId INT)
BEGIN
	START TRANSACTION;
	DELETE FROM `session_members` WHERE `player_id`=playerId AND `session_id`=sessionId;
    DELETE FROM `planetwars`.`session_list` WHERE `start_time` is NULL AND `id` NOT IN (SELECT `session_id` FROM `planetwars`.`session_members` WHERE `session_id`=sessionId);
    COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `unblock_user`(IN admin_id VARCHAR(30), IN user_id INT, IN reason VARCHAR(45))
BEGIN
	CALL change_user_state(TRUE, admin_id, user_id, reason);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
